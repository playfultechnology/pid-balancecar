...
void Robot_Select(void)
{
  ...
  if(Car_Mode>5)Car_Mode=5;
	...
	switch(Car_Mode)
	{ 
			case 0:       Robot_Init(MEC_BS_wheelspacing,         MEC_BS_axlespacing,           0,                     HALL_30F, Hall_13, Mecanum_75);             //麦克纳姆轮小车带摆式悬挂75mm
			case 1:       Robot_Init(MEC_BS_wheelspacing,         MEC_BS_axlespacing,           0,                     HALL_30F, Hall_13, Mecanum_60);            //麦克纳姆轮小车带摆式悬挂60mm
			case 2:       Robot_Init(MEC_wheelspacing,         MEC_axlespacing,          				0,                     HALL_30F, Hall_13, Mecanum_75);             //麦克纳姆轮小车不带摆式悬挂75mm
			case 3:	     Robot_Init(MEC_wheelspacing,         MEC_axlespacing,          				0,                     HALL_30F, Hall_13, Mecanum_60);            //麦克纳姆轮小车不带摆式悬挂60m
			case 4:			  Robot_Init(Four_Mortor_wheelSpacing, Four_Mortor__axlespacing, 				0,                     HALL_30F, Hall_13, Black_WheelDiameter);   //四驱车不带摆式悬挂 
			case 5:				Robot_Init(Four_Mortor_BS_wheelSpacing, Four_Mortor__BS_axlespacing,  0,                     HALL_30F, Hall_13, Black_WheelDiameter);   //四驱车带摆式悬挂
	}
}
