...
#define MEC_BS_wheelspacing         0.098f //修正2021.03.30						//带摆式悬挂
#define MEC_wheelspacing 						0.081f													//不带摆式悬挂

#define Four_Mortor_BS_wheelSpacing 0.098f														//带摆式悬挂		
#define Four_Mortor_wheelSpacing 		0.081f												//不带摆式悬挂		
//#define Tank_wheelSpacing        0.235f

//Axlespacing, Mec_Car is half axlespacing
//轴距 麦轮是一半
#define MEC_BS_axlespacing           0.087f															//带摆式悬挂
#define MEC_axlespacing           		0.085f															//不带摆式悬挂

#define Four_Mortor__BS_axlespacing  0.087f																//带摆式悬挂
#define Four_Mortor__axlespacing  	0.085f													//不带摆式悬挂
