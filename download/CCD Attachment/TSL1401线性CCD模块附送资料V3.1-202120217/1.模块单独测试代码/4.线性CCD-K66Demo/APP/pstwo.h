...
extern uint8 PS2_LX;//左摇杆X方向模拟量数据
extern uint8 PS2_LY;//左摇杆Y方向模拟量数据
extern uint8 PS2_RX;//右摇杆X方向模拟量数据
extern uint8 PS2_RY;//右摇杆Y方向模拟量数据
extern uint8 PS2_KEY;//PS2其他按键键值数据
