...
void FTM_PwmInit(FTM_Type * ftmn, FTM_CHn_e ch, uint16_t freq, uint16_t duty);//初始化FTM模式PWM通道

void FTM_PwmDuty(FTM_Type * ftmn, FTM_CHn_e ch, u16 duty);//设置PWM的占空比

void FTM_ABInit(FTM_Type * ftmn);//初始化FTM模式正交解码模式

short FTM_ABGet(FTM_Type * ftmn);//获取正交解码的计数数值
